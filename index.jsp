...
<body>
	<div class="card">
        <div class="card-body">
            ...
            <a href="https://www.harley-davidson.com/ac/en/index.html"><button type="button" class="btn btn-dark">Click To Buy!</button></a>
            <a href="https://en.wikipedia.org/wiki/DevOps"><button type="button" class="btn btn-success">I Love DevOps</button></a><br><br>
        </div>
      </div>
</body>
</html>
